...
/*
template<class Type>
void binaryTree<Type>::printInOrder() const
{
if (root == NULL)
{
std::cout << "EMPTY TREE" << std::endl;
...
template<class Type>
void binaryTree<Type>::printRecursiveInOrder(node<Type>* n) const
{
...
printRecursiveInOrder(n->getLeftChild());
cout << n->getValue() << " - ";
printRecursiveInOrder(n->getRightChild());
}
}

template<class Type>
void binaryTree<Type>::printPostOrder() const
{
if (root == NULL)
{
std::cout << "EMPTY TREE" << std::endl;
...
template<class Type>
void binaryTree<Type>::printRecursivePostOrder(node<Type>* n) const
{
...
printRecursivePostOrder(n->getLeftChild());
printRecursivePostOrder(n->getRightChild());
cout << n->getValue() << " - ";
}
}
*/
