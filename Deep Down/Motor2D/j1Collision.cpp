...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_IMP_BOMB_EXPLOSION][COLLIDER_PEASANT_SHOT] = false;
	...
	matrix[COLLIDER_MONKEY_COLL][COLLIDER_CATPEASANT] = false;
	matrix[COLLIDER_MONKEY_COLL][COLLIDER_PEASANT_SHOT] = false;
	matrix[COLLIDER_MONKEY_COLL][COLLIDER_IMP_BOMB] = false;
	matrix[COLLIDER_MONKEY_COLL][COLLIDER_IMP] = false;
